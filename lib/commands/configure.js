...
exports.description = 'Configure your Titanium development environment';
exports.help = function() {
	support.printHeader('titanium configure');
	console.log('');
	support.printAligned('Usage', 'titanium configure');
	console.log('\nOptions:');
